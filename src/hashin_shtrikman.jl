...
function Gu(K::Float64, c11::Float64, c12::Float64, c44::Float64)::Float64
    cs = Cs(c11, c12)
    a = 5.0 / (cs - c44)
    b = (18.0 / 5.0*c44) * (K + 2.0*c44) / (3.0*K + 4.0*c44)
    return c44 + 2.0*(a + b)^(-1)
end

function Gl(K::Float64, c11::Float64, c12::Float64, c44::Float64)::Float64
    cs = Cs(c11, c12)
    a = 5.0 / (c44 - cs)
